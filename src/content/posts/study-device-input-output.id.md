---
title: "Modul 7: Exploring Computer Input and Output "
subtitle: "Beragam komponen input dan output dalam komputer, termasuk keyboard, mouse, scanner, printer, dan banyak lagi. Ini adalah panduan yang komprehensif untuk mahasiswa yang ingin memahami peran penting komponen-komponen ini dalam pengolahan informasi dan teknologi komputer secara umum."
description: "Exploring computer input and output devices and peripherals"
date: 2023-10-09
category: "study"
semester: 1
course: "Pengantar Teknologi Informasi"
tags: ["input-output", "peripherals", "keyboard", "mouse", "printer", "monitor"]
lang: "id"
...
![Diagram alur data antara perangkat input, komputer, dan perangkat output](/images/inline/study-device-input-output-1.svg)

Komponen komputer terbagi menjadi dua kelompok besar:

- **Perangkat input** — digunakan untuk memasukkan data ke komputer.
- **Perangkat output** — digunakan untuk menampilkan atau mengeluarkan informasi dari komputer.

Bagian pertama mencakup keyboard, perangkat penunjuk (mouse), pen input (stilus dan tablet grafis), input berbasis gerakan, input suara, input video, serta pemindai dan pembaca optik. Bagian kedua membahas tampilan visual seperti monitor dan televisi digital, berbagai jenis printer (ink-jet, laser, 3D, all-in-one, dan mobile), serta perangkat output lain seperti headphone, data projector, interactive whiteboard, joystick, dan pengontrol permainan.

## Komponen Input


![Diagram kategori perangkat input dikelompokkan berdasarkan jenis interaksi](/images/inline/study-device-input-output-2.svg)

Tabel berikut merangkum contoh nyata perangkat input berdasarkan kategori dalam *Modul Pengantar Teknologi Informasi — Modul 7: Input dan Output*.
...
- **Keyboard ergonomis** dirancang untuk mengurangi cedera regangan pergelangan tangan saat mengetik dalam waktu lama.
- **Mouse optik** berfungsi sebagai perangkat penunjuk utama untuk navigasi antarmuka grafis.
- **Scanner flatbed** memindai dokumen dan gambar berukuran lembaran menjadi bentuk digital.
- **Stylus pada graphics tablet** digunakan untuk menggambar, menulis tangan digital, dan penyuntingan presisi.
...
- **Speaker dan headphone** menghasilkan keluaran audio untuk musik, panggilan, atau efek game.
