...
description: "This folder is set up as a hands-on course to learn computer networking with Cisco Packet Tracer."
category: "study"
...
This folder is set up as a hands-on course to learn computer networking with Cisco Packet Tracer.

## Course structure

- `00-getting-started/` - setup, goals, and workflow
- `01-network-fundamentals/` - IP basics and connectivity
- `02-switching/` - VLANs, trunks, and STP basics
- `03-routing/` - static routing and OSPF fundamentals
- `04-services-security/` - DHCP, NAT, ACL, and basic security
...
- `packet-tracer-files/` - keep your `.pkt` lab files
- `submissions/` - final reports and exported deliverables

## How to use this course

1. Start with `00-getting-started/README.md`.
2. Complete modules in order (`01` to `05`).
3. For each lab:
   - read the instructions file
   - build and test the topology in Cisco Packet Tracer
   - save your file in `packet-tracer-files/`
   - complete a report using `templates/lab-report-template.md`
4. Track your weekly progress with `resources/study-plan-8-weeks.md`.

## Naming convention for files

- Packet Tracer files: `lab-<number>-<topic>-v<version>.pkt`
- Reports: `lab-<number>-report.md`
